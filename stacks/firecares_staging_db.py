...
rabbit_mq_sg = t.add_resource(SecurityGroup(
    ...
    SecurityGroupIngress=[
        ...
        SecurityGroupRule("TylerAccessWeb", IpProtocol="tcp", FromPort="15672", ToPort="15672", CidrIp="73.173.214.176/32"),
        ...
        SecurityGroupRule("JoeAccess4Web", IpProtocol="tcp", FromPort="15672", ToPort="15672", CidrIp="75.133.14.178/32"),
        SecurityGroupRule("SontagAccess4Web", IpProtocol="tcp", FromPort="15672", ToPort="15672", CidrIp="47.215.167.239/32"),
